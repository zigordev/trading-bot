  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(defaults.caption_label, 'text-[13px] font-medium'),
        ...
        day: cn(defaults.day, 'size-9 p-0 text-center align-middle text-[13px]'),
        day_button: cn(
          defaults.day_button,
        ...
        today: cn(defaults.today, 'font-semibold text-[var(--color-accent)]'),
        outside: cn(defaults.outside, 'text-[var(--color-fg-subtle)] opacity-50'),
