...
export function MetricGate({ label, status, actual, threshold, hint, className }: MetricGateProps) {
  ...
  return (
    ...
    >
      <span className="inline-flex items-center gap-1.5">
        <span
          className={cn('flex size-4 items-center justify-center rounded-full', STATUS_BADGE.pass)}
        >
      ...
      <span className="inline-flex items-center gap-1.5">
        <span
          className={cn('flex size-4 items-center justify-center rounded-full', STATUS_BADGE.fail)}
        >
      ...
      <span className="inline-flex items-center gap-1.5">
        <span
          className={cn('flex size-4 items-center justify-center rounded-full', STATUS_BADGE.skip)}
        >
