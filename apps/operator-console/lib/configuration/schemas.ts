...
export const configResources: Record<string, ConfigResourceDefinition> = {
  ...
  timeframes: {
    ...
    fields: [
      {
        name: 'code',
        labelKey: 'configuration.fields.timeframes.code',
        kind: 'text',
        placeholder: '1m',
      },
      {
        name: 'longerTimeframeCode',
        labelKey: 'configuration.fields.timeframes.longerTimeframeCode',
        kind: 'text',
      },
      {
  ...
  strategies: {
    ...
    fields: [
      ...
      {
        name: 'description',
        labelKey: 'configuration.fields.strategies.description',
        kind: 'textarea',
        rows: 2,
      },
  ...
  'risk-profiles': {
    ...
    fields: [
      ...
      {
        name: 'description',
        labelKey: 'configuration.fields.risk-profiles.description',
        kind: 'textarea',
        rows: 2,
      },
      {
        name: 'maximumStopLoss',
        labelKey: 'configuration.fields.risk-profiles.maximumStopLoss',
        kind: 'number',
      },
      {
        name: 'minimumStopLoss',
        labelKey: 'configuration.fields.risk-profiles.minimumStopLoss',
        kind: 'number',
      },
  ...
  'analysis-settings': {
    ...
    fields: [
      ...
      {
        name: 'enabled',
        labelKey: 'configuration.fields.analysis-settings.enabled',
        kind: 'boolean',
      },
    ],
  },
  'execution-settings': {
    ...
    fields: [
      ...
      {
        name: 'enabled',
        labelKey: 'configuration.fields.execution-settings.enabled',
        kind: 'boolean',
      },
      {
        name: 'mode',
      ...
      {
        name: 'autoPromote',
        labelKey: 'configuration.fields.execution-settings.autoPromote',
        kind: 'boolean',
      },
      {
        name: 'maxPromotions',
        labelKey: 'configuration.fields.execution-settings.maxPromotions',
        kind: 'number',
      },
      {
        ...
        options: [
          ...
          {
            value: 'flatten',
            labelKey: 'configuration.fields.execution-settings.policyOptions.flatten',
          },
        ],
      },
    ],
