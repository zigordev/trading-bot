...
type ListResolvedAnalysisSettings = (pool: Pool) => Promise<ResolvedAnalysisSettingsRecord[]>;

export const registerRuntimeConfigRoutes = (
  app: FastifyInstance,
  pool: Pool,
  listResolvedAnalysisSettingsFn: ListResolvedAnalysisSettings = listResolvedAnalysisSettings
): void => {
